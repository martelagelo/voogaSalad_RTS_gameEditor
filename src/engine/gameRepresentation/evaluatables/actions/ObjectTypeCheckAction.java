...
public class ObjectTypeCheckAction extends Action {
    ...
    public ObjectTypeCheckAction (EvaluatorFactory factory,
    ...
    protected Evaluatable<?> initializeAction (String[] args,
        ...
        Evaluatable<?> participantAttr =
                new ParticipantValueParameter(identifyParticipantsOfInterest(args[11],
                                                                             participantManager),
                                              args[12]);
        Evaluatable<?> playerAttr =
                new NumericAttributeParameter(args[10], elementManager, new ActorObjectIdentifier());
        Evaluator<?, ?, ?> participantParameterSetter =
                factory.makeEvaluator(args[9], participantAttr, playerAttr);
        // Combine it all
