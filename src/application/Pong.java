...
public class Pong extends Application {
    ...
    private Engine hardCodeAGame () throws Exception {
        ...
        paddle.attributes.setNumericalAttribute(StateTags.HEALTH.getValue(), 200);
        ...
        paddle.addAttributeDisplayerState(new AttributeDisplayerState(
                ...
                0, 1));
        paddle.addAttributeDisplayerState(new AttributeDisplayerState(
                AttributeDisplayerTags.ATTRIBUTE_BAR_DISPLAYER, StateTags.HEALTH.getValue(), 0, 200));
        SelectableGameElementState enemyPaddle = createPaddle(350, 700, 2);
        enemyPaddle.setBounds(bounds);
        enemyPaddle.attributes.setNumericalAttribute(StateTags.TEAM_COLOR.getValue(),
                Long.parseLong("008000", 16));
        enemyPaddle.attributes.setNumericalAttribute(StateTags.HEALTH.getValue(), 200);
    ...
    private SelectableGameElementState createGoalDisplayMarker () throws SaveLoadException {
        ...
        AnimatorState goalAnimations = SaveLoadUtility.loadResource(AnimatorState.class,
        ...
        goalDisplayMarker.attributes.setTextualAttribute(StateTags.CURRENT_ACTION.getValue(),
                "STANDING");
        goalDisplayMarker.attributes.setNumericalAttribute(StateTags.TEAM_COLOR.getValue(),
    ...
    private SelectableGameElementState createBoundary (double x, double y) throws SaveLoadException {
        ...
        boundary.attributes.setNumericalAttribute(StateTags.TEAM_COLOR.getValue(),
                Long.parseLong("0000FF", 16));
        boundary.addType("boundary");
        double[] bounds = { 0, 0, 0, 1000, 10, 1000, 10, 0 };
        boundary.setBounds(bounds);

        AnimatorState boundaryAnimations = SaveLoadUtility.loadResource(AnimatorState.class,
                "resources/gameelementresources/animatorstate/archer.json");
    ...
    private SelectableGameElementState createGoalRegion (double x, double y, boolean mine)
        ...
        boundary.attributes.setNumericalAttribute(StateTags.Y_SPAWN_OFFSET.getValue(), (mine ? 500
                : -800));
    ...
    private SelectableGameElementState createPaddle (double x, double y, int teamID)
        ...
        paddle.attributes.setNumericalAttribute(StateTags.TEAM_COLOR.getValue(),
                Long.parseLong("0000FF", 16));
        ...
        AnimatorState paddleAnimations = SaveLoadUtility.loadResource(AnimatorState.class,
                "resources/gameelementresources/animatorstate/archer.json");
