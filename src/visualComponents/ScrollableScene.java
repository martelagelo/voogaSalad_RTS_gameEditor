        ...
        this.setOnMouseMoved(new EventHandler<MouseEvent>(){
            ...
            private void setScrollSpeed (double mouseX, double mouseY) {
                if(mouseX < SLOW_SCROLL_BOUNDARY){
                    ...
                    myBackground.setXScrollSpeed(SLOW_SPEED);
                    if(mouseX > myWidth - FAST_SCROLL_BOUNDARY) myBackground.setXScrollSpeed(FAST_SPEED);
                }
                else if(mouseY > myHeight - SLOW_SCROLL_BOUNDARY){
                    myBackground.setYScrollSpeed(SLOW_SPEED);
                    if(mouseY > myHeight - FAST_SCROLL_BOUNDARY) myBackground.setYScrollSpeed(FAST_SPEED);
                }
                else{
...
//                    }
        ...
        setOnMouseReleased(new EventHandler<MouseEvent>() {
            ...
            public void handle (MouseEvent event) {
                ...
                Point2D center = new Point2D(mySelectionBox.xProperty().doubleValue(), mySelectionBox.yProperty().doubleValue());
//                if(mySelectionBox.contains(new Point2D(c.getCenterX(), c.getCenterY())) || c.contains(center)){
//                    c.select();
//                }
            }
