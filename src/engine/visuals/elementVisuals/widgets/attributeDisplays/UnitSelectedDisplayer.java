...
/**
 * A displaying module that displays whether the unit is selected with a triangle
 * 
 * @author Stanley
 *
 */
...
public class UnitSelectedDisplayer extends AttributeDisplayer {
    ...
    public UnitSelectedDisplayer (AttributeContainer attributes,
    ...
    protected Group createDisplay () {
        ...
        mySelectionTriangle.getPoints().addAll(new Double[]{
                                                0.0, 0.0,
                                                TRIANGLE_SIDE_LENGTH, 0.0,
                                                0.0, TRIANGLE_SIDE_LENGTH });
