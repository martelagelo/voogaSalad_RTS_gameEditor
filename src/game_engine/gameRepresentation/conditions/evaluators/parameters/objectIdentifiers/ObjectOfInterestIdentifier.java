 ...
 * over inheritance for the evaluator parameters. This allows each parameter to act on a wide range
 * of gameElements without requiring a large hierarchy of parameter types.
 *
 * @author Zach
 *
 */
