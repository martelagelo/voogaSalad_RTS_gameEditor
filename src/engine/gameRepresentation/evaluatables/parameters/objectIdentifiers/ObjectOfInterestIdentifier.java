 ...
 * gameElements without requiring a large hierarchy of parameter types. For example, instead of
 * making an actor parameter, an actee parameter, and a global parameter, a single class can be made
 * and inheritance used to only necessitate one class instead of three.
 *
 * @author Zach
 *
 */
