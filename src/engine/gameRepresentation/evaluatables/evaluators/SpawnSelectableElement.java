...
/**
 * Spawn a selectable element at the location of the calling game element parameter's spawn
 * location; Return the element that was created.
 * 
 * @author Zach
 *
 */
public class SpawnSelectableElement<A, B> extends Evaluator<A, B, SelectableGameElement> {
    ...
    public SpawnSelectableElement (Evaluatable<A> parameter1,
                ...
                .addSelectableGameElementToLevel(promise.getElementName(),
                                                 ...
                                                 element.getNumericalAttribute(StateTags.Y_POSITION
                                                         ...
                                                         element.getNumericalAttribute(StateTags.Y_SPAWN_OFFSET
                                                                                               .getValue())
                                                                 .doubleValue(),
                                                 element.getTextualAttribute(StateTags.TEAM_COLOR
                                                         .getValue()));
