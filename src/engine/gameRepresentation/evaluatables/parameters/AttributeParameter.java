...
/**
 * An evaluator parameter that extracts a numerical or textual attribute
...
public abstract class AttributeParameter<T> extends Parameter<T> {
     ...
     */
    public AttributeParameter (Class<T> type, String attributeTag, GameElementManager manager,
     ...
     */
    public AttributeParameter (Class<T> type, String attributeTag, GameElementManager manager,
            ObjectOfInterestIdentifier objectOfInterestIdentifier, String elementTag) {
     ...
     * @return
     */
    private List<GameElement> getElementsOfInterest (GameElementManager elementManager,
     ...
     */
    protected abstract boolean setValue (List<GameElement> elements, String attributeTag,
            T attributeValue);
}
