...
/**
 * An action that checks an attribute value with an evaluator then sets an
 * attribute value with an evaluator of the current object
 *
...
public class CheckAttributeSetAttributeAction extends Action {
    ...
    public CheckAttributeSetAttributeAction (EvaluatorFactory factory, GameElementManager manager,
    ...
    protected Evaluatable<?> initializeAction (String[] args, EvaluatorFactory factory,
        ...
        Evaluatable<?> attr1Param = new NumericAttributeParameter(args[1], null,
                makeObjectIdentifier(args[0]));
        Evaluatable<?> desiredValueParam = new NumberParameter(Double.valueOf(args[3]));
        Evaluator<?, ?, ?> conditionEvaluator = factory.makeEvaluator(args[2], attr1Param,
                desiredValueParam);
        Evaluatable<?> attr2Param = new NumericAttributeParameter(args[5], null,
