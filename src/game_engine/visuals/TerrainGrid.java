...
public class TerrainGrid {
    ...
    public int[][] generateDefaultGrid (double mapWidth, double mapHeight) {
        int[][] g =
                new int[(int) (mapWidth / TILE_X_DIMENSION) + 3][(int) (2 * mapHeight /
                                                                        TILE_Y_DIMENSION + 6)];
        ...
        for (int i = 0; i < terrainArray.length; i++) {
            for (int j = 0; j < terrainArray[0].length; j++) {
                ...
                DrawableGameElementState grass =
                        new DrawableGameElementState(-TILE_X_DIMENSION + i * TILE_X_DIMENSION +
                                                     deltaX,
                                                     -TILE_Y_DIMENSION + j * TILE_Y_DIMENSION / 2);
                grass.setSpritesheet(new Spritesheet("resources/img/graphics/terrain/grass/" +
                                                     (r.nextInt(99) + 1) + ".png",
