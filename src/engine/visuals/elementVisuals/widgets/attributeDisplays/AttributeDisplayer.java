...
public abstract class AttributeDisplayer implements Updatable, Widget {
     ...
     */
    public AttributeDisplayer (AttributeContainer attributes, String numericParameterTag,
    ...
    public boolean update () {
        toggleOpacity();
        updateDisplay(attributesOfInterest.getNumericalAttribute(myParameterTag).doubleValue(),
     ...
     */
    protected abstract void updateDisplay (double attributeValue, double attributeMinValue,
