 ...
 * object. Used for collision resolution
 * 
 * @author Zach
 */
public class RandomWaypoint<A, B> extends Evaluator<A, B, Boolean> {
    ...
    public RandomWaypoint (Evaluatable<A> parameter1,
    ...
    public Boolean evaluate (GameElement element1, GameElement element2) {
        ...
        double xGoal =
                element.getNumericalAttribute(StateTags.X_TEMP_GOAL_POSITION.getValue())
                        .doubleValue();
        double yGoal =
                element.getNumericalAttribute(StateTags.Y_TEMP_GOAL_POSITION.getValue())
                        .doubleValue();
        double speed =
                element.getNumericalAttribute(StateTags.MOVEMENT_SPEED.getValue()).doubleValue();
