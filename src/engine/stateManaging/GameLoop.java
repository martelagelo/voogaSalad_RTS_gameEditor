...
/**
 * The main loop for running the game, checking for collisions, and updating
 * game entities
 *
...
public class GameLoop extends Observable {
    ...
    public GameLoop (Level level, VisualManager visualManager, ParticipantManager participantManager) {
        myVisualManager = visualManager;
        myParticipantManager = participantManager;
        myCurrentLevel = level;
        myComputers = new ArrayList<>();
