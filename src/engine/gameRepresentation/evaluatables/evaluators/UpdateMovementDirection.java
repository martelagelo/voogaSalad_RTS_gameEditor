...
public class UpdateMovementDirection<A, B> extends Evaluator<A, B, Boolean> {
    ...
    public UpdateMovementDirection (Evaluatable<A> parameter1,
    ...
    public Boolean evaluate (GameElement element1, GameElement element2) {
        ...
        double deltaX =
                element1.getNumericalAttribute(StateTags.X_TEMP_GOAL_POSITION.getValue())
                        .doubleValue() -
                        element1.getNumericalAttribute(StateTags.X_POSITION.getValue())
                                .doubleValue();
        double deltaY =
                element1.getNumericalAttribute(StateTags.Y_TEMP_GOAL_POSITION.getValue())
                        .doubleValue() -
