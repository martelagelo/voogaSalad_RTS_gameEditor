...
public class ScrollableBackground extends StackPane
{
    ...
    public ScrollableBackground(double screenWidth, double screenHeight, double xBoundary, double yBoundary)
    {
    ...
    public void update(){
        if((getTranslateX()>=0 && myXScrollSpeed < 0) || (-getTranslateX()>=(myXBoundary-myWidth) && myXScrollSpeed>0)) setXScrollSpeed(0);
        if((getTranslateY()>=0 && myYScrollSpeed < 0) || (-getTranslateY()>=(myYBoundary-myHeight) && myYScrollSpeed>0)) setYScrollSpeed(0);
